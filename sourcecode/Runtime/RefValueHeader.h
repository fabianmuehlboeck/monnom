...
namespace Nom
{
	namespace Runtime
	{
		...
		public:
			...
			static int GenerateRefOrPrimitiveValueSwitch(NomBuilder& builder, NomValue value, llvm::BasicBlock** refValueBlock, llvm::BasicBlock** intBlock, llvm::BasicBlock** floatBlock, int refWeight, int intWeight = 50, int floatWeight = 40, int boolWeight = 30);
