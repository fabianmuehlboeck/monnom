...
namespace Nom
{
	namespace Runtime
	{
		class RTRecordValue : public RTPWTypedValue<PWRecord, NomTypeRef>
		{
		protected:
			RTRecordValue(const PWRecord _val, NomTypeRef _type, bool _isfc = false);
		public:
			virtual ~RTRecordValue() override {}
			static RTRecordValue* Get(NomBuilder& builder, const PWRecord _val, NomTypeRef _type, bool _isfc = false);
