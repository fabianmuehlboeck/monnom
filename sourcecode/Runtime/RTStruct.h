...
namespace Nom
{
	...
	{
		class NomStruct;
		enum class RTStructFields : unsigned char { NomLink = 0, FieldLookup = 1, FieldStore = 2, DispatcherLookup = 3, /* Dictionary = 1,*/ FieldCount = 4/*2*/, TypeArgCount=5/*3*/, PreallocatedSlots = 6/*4*/, SpecializedVTableCastID = 7/*5*/,  SpecializedVTable = 8/*6*/ };
		class RTStruct : public ARTRep<RTStruct, RTStructFields>
		{
		public:
			static llvm::StructType* GetLLVMType();
			static llvm::Constant* CreateConstant(const NomStruct* structptr, llvm::Function* fieldRead, llvm::Function* fieldWrite, llvm::Function* lookupDispatcher/*, llvm::Constant* dictPointer*/);
