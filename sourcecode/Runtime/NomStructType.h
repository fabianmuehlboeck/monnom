...
namespace Nom
{
	namespace Runtime
	{
		class NomStructType : public NomType
		{
		private:
			NomStructType() {}
		public:
			static NomStructType& Instance();
			virtual ~NomStructType() override {}
			...
			virtual bool IsSubtype(NomTypeRef other, bool optimistic=true) const override;
			virtual bool IsSubtype(NomBottomTypeRef other, bool optimistic=true) const override;
			virtual bool IsSubtype(NomClassTypeRef other, bool optimistic=true) const override;
			virtual bool IsSubtype(NomTopTypeRef other, bool optimistic=true) const override;
			virtual bool IsSubtype(NomTypeVarRef other, bool optimistic=true) const override;
			virtual bool IsSupertype(NomTypeRef other, bool optimistic=true) const override;
			virtual bool IsSupertype(NomBottomTypeRef other, bool optimistic=true) const override;
			virtual bool IsSupertype(NomClassTypeRef other, bool optimistic=true) const override;
			virtual bool IsSupertype(NomTopTypeRef other, bool optimistic=true) const override;
			virtual bool IsSupertype(NomTypeVarRef other, bool optimistic=true) const override;
