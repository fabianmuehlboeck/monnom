	...
	namespace Runtime
	{
		...
		void CallCheckedInstanceMethod::Compile(NomBuilder& builder, CompileEnv* env, int lineno)
		{
			...
			*/
			...
			{
				llvm::Value* arg1 = env->GetArgument(i);
		...
		void CallCheckedInstanceMethod::CompileDirectly (NomInstantiationRef<const NomMethod> method, TypeList argTypes, NomBuilder& builder, CompileEnv* env, int lineno)
		{
