...
namespace Nom
{
	namespace Runtime
	{
		...
		llvm::Constant* RTLambda::CreateConstant([[maybe_unused]] const NomLambda* lambda, llvm::Constant* interfaceMethodTable, llvm::Constant* dynamicDispatcherTable, llvm::Function* fieldRead, llvm::Function* fieldWrite)
		{
