...
/// <reference path="transformers/contracts.ts" />
/// <reference path="transformers/annotationMangler.ts" />
...
namespace ts {
    ...
    export function getTransformers(compilerOptions: CompilerOptions) {
        ...
        if (compilerOptions.annotationMangler) {
            transformers.push(transformAnnotationMangler);
            return transformers;
        }

        if (compilerOptions.generateContracts) {
            transformers.push(transformGenerateContracts);
        }
