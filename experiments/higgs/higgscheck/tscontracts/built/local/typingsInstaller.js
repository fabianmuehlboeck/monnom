...
(function (ts) {
    ...
    (function (SyntaxKind) {
        ...
        SyntaxKind[SyntaxKind["JsxSpreadAttribute"] = 253] = "JsxSpreadAttribute";
        SyntaxKind[SyntaxKind["JsxExpression"] = 254] = "JsxExpression";
        // Clauses
        SyntaxKind[SyntaxKind["CaseClause"] = 255] = "CaseClause";
        SyntaxKind[SyntaxKind["DefaultClause"] = 256] = "DefaultClause";
        SyntaxKind[SyntaxKind["HeritageClause"] = 257] = "HeritageClause";
        SyntaxKind[SyntaxKind["CatchClause"] = 258] = "CatchClause";
        ...
        // Enum
        SyntaxKind[SyntaxKind["EnumMember"] = 262] = "EnumMember";
        // Top-level nodes
        SyntaxKind[SyntaxKind["SourceFile"] = 263] = "SourceFile";
        SyntaxKind[SyntaxKind["Bundle"] = 264] = "Bundle";
        // JSDoc nodes
        SyntaxKind[SyntaxKind["JSDocTypeExpression"] = 265] = "JSDocTypeExpression";
        // The * type
        SyntaxKind[SyntaxKind["JSDocAllType"] = 266] = "JSDocAllType";
        // The ? type
        SyntaxKind[SyntaxKind["JSDocUnknownType"] = 267] = "JSDocUnknownType";
        SyntaxKind[SyntaxKind["JSDocArrayType"] = 268] = "JSDocArrayType";
        SyntaxKind[SyntaxKind["JSDocUnionType"] = 269] = "JSDocUnionType";
        SyntaxKind[SyntaxKind["JSDocTupleType"] = 270] = "JSDocTupleType";
        SyntaxKind[SyntaxKind["JSDocNullableType"] = 271] = "JSDocNullableType";
        SyntaxKind[SyntaxKind["JSDocNonNullableType"] = 272] = "JSDocNonNullableType";
        SyntaxKind[SyntaxKind["JSDocRecordType"] = 273] = "JSDocRecordType";
        SyntaxKind[SyntaxKind["JSDocRecordMember"] = 274] = "JSDocRecordMember";
        SyntaxKind[SyntaxKind["JSDocTypeReference"] = 275] = "JSDocTypeReference";
        ...
        SyntaxKind[SyntaxKind["JSDocConstructorType"] = 279] = "JSDocConstructorType";
        SyntaxKind[SyntaxKind["JSDocThisType"] = 280] = "JSDocThisType";
        SyntaxKind[SyntaxKind["JSDocComment"] = 281] = "JSDocComment";
        SyntaxKind[SyntaxKind["JSDocTag"] = 282] = "JSDocTag";
        SyntaxKind[SyntaxKind["JSDocAugmentsTag"] = 283] = "JSDocAugmentsTag";
        ...
        SyntaxKind[SyntaxKind["JSDocLiteralType"] = 291] = "JSDocLiteralType";
        SyntaxKind[SyntaxKind["JSDocNullKeyword"] = 292] = "JSDocNullKeyword";
        SyntaxKind[SyntaxKind["JSDocUndefinedKeyword"] = 293] = "JSDocUndefinedKeyword";
        SyntaxKind[SyntaxKind["JSDocNeverKeyword"] = 294] = "JSDocNeverKeyword";
        // Synthesized list
    ...
    (function (ObjectFlags) {
        ...
        ObjectFlags[ObjectFlags["NonPrimitive"] = 1024] = "NonPrimitive";
...
(function (ts) {
    ...
    function shimMap() {
        ...
        // FIXME: Working around a Higgs bug
        return (function () {
            function class_1() {
            ...
            class_1.prototype.keys = function () {
                return new MapIterator(this.data, function (_data, key) { return key.replace(/^\./, ""); });
            };
            ...
            class_1.prototype.entries = function () {
                return new MapIterator(this.data, function (data, key) { return [key.replace(/^\./, ""), data[key]]; });
            };
            class_1.prototype.forEach = function (action) {
                for (var key in this.data) {
                    action(this.data[key], key.replace(/^\./, ""));
                }
            };
            return class_1;
        }());
...
(function (ts) {
    ...
    ts.sys = (function () {
        ...
        function getHiggsSystem() {
            var _console = require("lib/console");
            var _stdio = require("lib/stdio");
            ...
            var higgsSystem = {
                ...
                write: function (str) {
                    writeStr += str;
                    if (writeStr.match(/\n$/)) {
                        str = writeStr.replace(/\n$/, "");
                        _console.log(str);
                        writeStr = "";
                    }
                },
                readFile: function (path) {
                    return _stdio.readFile(path);
                },
                writeFile: function (path, data) {
                    var f = _stdio.fopen(path, "w");
                    f.write(data);
                    f.close();
                },
                ...
                getExecutingFilePath: function () {
                    // FIXME
                    return "built/local/tsc.js";
                },
                getCurrentDirectory: _dir.getcwd,
                getDirectories: function (path) {
                    return _dir.dir(path).getDirNames();
                },
                exit: function (exitCode) {
                    throw exitCode;
                }
        ...
        else if (typeof $rt_in !== "undefined" && typeof require !== "undefined") {
            sys = getHiggsSystem();
        }
        if (sys) {
...
(function (ts) {
    ts.Diagnostics = {
        ...
        Generate_HiggsCheck_contracts: { code: 584001, category: ts.DiagnosticCategory.Message, key: "Generate_HiggsCheck_contracts_584001", message: "Generate HiggsCheck contracts." },
    };
})(ts || (ts = {}));
/// <reference path="core.ts"/>
    ...
    */
    ...
    function createScanner(languageVersion, skipTrivia, languageVariant, text, onError, start, length) {
        ...
        function setText(newText, start, length) {
            // FIXME: This is working around a nasty bug in Higgs
...
(function (ts) {
    ...
    ts.optionDeclarations = [
        ...
        },
        {
            ...
            type: "boolean",
            description: ts.Diagnostics.Generate_HiggsCheck_contracts
        },
        {
            name: "annotationMangler",
            type: "string"
        },
        {
...
(function (ts) {
    ...
    (function (server) {
        ...
        (function (typingsInstaller) {
            ...
            var installer = new NodeTypingsInstaller(globalTypingsCacheLocation, /*throttleLimit*/ 5, log);
            installer.listen();
        })(typingsInstaller = server.typingsInstaller || (server.typingsInstaller = {}));
    })(server = ts.server || (ts.server = {}));
})(ts || (ts = {}));
//# sourceMappingURL=file:////home/user/vm-gradual-typing/typescript-contracts/built/local/typingsInstaller.js.map