...
// [Gregor] FIXME: Circular reference brought up by our more thorough type resolution   type IDBValidKey = number | string | Date | IDBArrayKey;
type IDBValidKey = number | string | Date;
